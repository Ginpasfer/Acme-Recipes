...
<acme:form readonly="true">
	<div class="row">
		...
		<div class="column-50">
					...
					<tr>
						...
						<jstl:if test="${ amount>0 }">
							<th scope="row" style="width: 15%"><acme:message
									code="epicure.dashboard.form.status.${ key }" /></th>
			...
			<h3>
				<acme:message
					code="epicure.epicure-dashboard.form.label.average-number-of-budgets-by-currency-and-status" />
			</h3>
			...
			<caption></caption>
				<jstl:forEach
					...
					<tr>
						...
						<jstl:if test="${ amount>0 }">
							<th scope="row" style="width: 15%"><acme:message
									code="epicure.dashboard.form.status.${ key.getFirst() }" /></th>
							<td><acme:print value="${ amount }" /></td>
						</jstl:if>
			...
			<h3>
				<acme:message
					code="epicure.epicure-dashboard.form.label.deviation-of-budgets-by-currency-and-status" />
			</h3>
			...
			<h3>
				<acme:message
					code="epicure.epicure-dashboard.form.label.min-budget-by-currency-and-status" />
			</h3>
			...
			<h3>
				<acme:message
					code="epicure.epicure-dashboard.form.label.max-budget-by-currency-and-status" />
			</h3>
			<table class="table table-sm">
			<caption></caption>
